...
export const IconFolder = ({ className = "icon-folder" }: { className?: string }) => (
...
export const IconDoc = () => (
  <svg class="icon-doc" viewBox="0 0 24 24">
...
export const IconSheet = () => (
  <svg class="icon-sheet" viewBox="0 0 24 24">
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
...
export const IconSharedBadge = () => (
  <svg
    viewBox="0 0 24 24"
    style="width: 14px; height: 14px; margin-left: 6px; color: var(--icon-blue)"
  >
    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
    <circle cx="9" cy="7" r="4" />
    <path d="M23 21v-2a4 4 0 0 0-3-3.87" />
